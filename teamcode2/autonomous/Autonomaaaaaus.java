...
@Autonomous(name="Right Side: color 2", group="Linear Opmode")

public class Autonomaaaaaus extends LinearOpMode{
    ...
    public void LMDrive(int Pos1, int Pos2, int Pos3, int Pos4) {
        LFD.setTargetPosition(Pos1);
        RFD.setTargetPosition(Pos2);
        LBD.setTargetPosition(Pos3);
        RBD.setTargetPosition(Pos4);
    ...
    public void RMDrive(int Pos1, int Pos2, int Pos3, int Pos4) {
        LFD.setTargetPosition(Pos1);
        RFD.setTargetPosition(Pos2);
        LBD.setTargetPosition(Pos3);
        RBD.setTargetPosition(Pos4);
    ...
    public void Color() {
            while (opModeIsActive()) {
                ...
                if (color.red() > color.green() && color.red() > color.blue()) {
                    ...
                    MDrive(-754, 754, 754, -754);/*  1116   1 inch = 62 */
                    RunToPosition();
                    Velocity(1);
                    SRPower(0.4); 
                    Telemetry2();
