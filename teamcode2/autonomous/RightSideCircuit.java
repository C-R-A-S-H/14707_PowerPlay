...
@Autonomous(name="Right Side Blue", group="Linear Opmode")

public class RightSideCircuit extends LinearOpMode{
    ...
    public void Color() {
            while (opModeIsActive()) {
                ...
                if (color.green() > color.red() && color.green() > color.blue()) {
                    ...
                    MDrive(2976, 2976, 2976, 2976);/*  1116   1inch = 62 */
                    RunToPosition();
                    Velocity(1);
                    Power(0.3);
                    Telemetry2();
                    ...
                    MDrive(-6438, -6438, -6438, -6438);/*  1116   1inch = 62 */
                    RunToPosition();
                    Velocity(1);
                    Power(0.3);
                    Telemetry2();
