...
@TeleOp(name="Potentiometer_test", group="Linear Opmode")
...
public class Potentiometer_test extends LinearOpMode {
    ...
    private AnalogInput PS;
    
    double PSCurrentVoltage;
    ...
    public void runOpMode() {
        ...
        PS = hardwareMap.get(AnalogInput.class, "potentiometer_sensor");
        ...
        while (opModeIsActive()) {
            ...
            PSCurrentVoltage = PS.getVoltage();
            
            // Turn the motor on or off based on the potentiometer’s position
            if (PSCurrentVoltage < 1.65) {
                armR.setPower(-1);
                telemetry.addData("Potentiometer", "active");
            } else {
                // armR.setPower(0.3);
                telemetry.addData("Potentiometer", "not active");
            }
            ...
            */
            ...
            // Show the elapsed game time and wheel power.
                ...
                telemetry.addData("Potentiometer voltage", PSCurrentVoltage);
