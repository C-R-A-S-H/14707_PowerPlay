...
public class Onedriver extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            double axial   =  (1 * -gamepad1.left_stick_y); // forward and backward
            double lateral = (0.7 * -gamepad1.right_stick_x); // turning left and right
            double yaw     =  (1 * -gamepad1.left_stick_x); // stafing
            ...
            */
            ...
            double up = (-1 * gamepad1.right_trigger);
            double down = (1 * -gamepad1.left_trigger);
            
            HoldPos(0.2);
            // armPower2 = (1 * -gamepad1.left_trigger);
            Touch();
            double armPower = down - up;
            HoldPos(0.2);
            Touch();
            //Telemetry();
