...
@TeleOp(name="Magnet_Test", group="Linear Opmode")

public class Magnet_test extends Trying {
    ...
    private DigitalChannel M_touch;
    ...
    public void M_Touch() {
        if (M_touch.getState() == true) {
            telemetry.addData("Magnet Touch", "Is Not Pressed");
        } else {
            ArmPower(-.5);
            telemetry.addData("Magnet Touch", "Is Pressed");
        }
    }
    @Override
    public void runOpMode() {
        ...
        M_touch = hardwareMap.get(DigitalChannel.class, "magnet_touch");
